...
L_fc16:
fc16:    5f           rotate_left A, B ; Setup stack at 0x1000 (probally)
...
fc5d:    f5 a2        unknown
fc5f:    2f           rotate_left AL, AL
fc60:    14 2f        b_z L_fc91
fc62:    06           flag6
fc63:    2f           rotate_left AL, AL
fc64:    a0           unknown
fc65:    90 ff f6     liw A, 0xfff6
fc68:    2f           rotate_left AL, AL
fc69:    02           flag2
fc6a:    7b 22        call L_fc8e
fc6c:    43           (0x43)
fc6d:    90 01 00     liw A, 0x0100
fc70:    2f           rotate_left AL, AL
fc71:    00           HALT
fc72:    90 f0 ff     liw A, 0xf0ff
fc75:    2f           rotate_left AL, AL
fc76:    02           flag2
fc77:    7b 15        call L_fc8e
fc79:    45 15        mov CL, AL
fc7b:    03           flag3
...
fcb0:    49           sub AL, BL ; Check if char is lowercase (greater than 0x60)
fcb1:    16 04        b_lt L_fcb7
fcb3:    c0 df        lib B, 0xdf
fcb5:    42 31        xor AL, BL ; Clear bit 6, forcing it to be uppercase
...
fd6a:    2f           rotate_left AL, AL
fd6b:    00           HALT
fd6c:    51 80        sub A, E
fd6e:    3b           or A, A
fd6f:    2f           rotate_left AL, AL
fd70:    02           flag2
fd71:    2f           rotate_left AL, AL
fd72:    34 2f        shift_right {HL, LH}, B
fd74:    06           flag6
...
fd85:    2f           rotate_left AL, AL
fd86:    00           HALT
fd87:    90 ea 1f     liw A, 0xea1f
fd8a:    2f           rotate_left AL, AL
fd8b:    02           flag2
fd8c:    2f           rotate_left AL, AL
fd8d:    34 2f        shift_right {HL, LH}, B
fd8f:    06           flag6
...
L_fde4:
fde4:    07           clear_carry?
fde5:    37 40        rotate_left A, C
fde7:    29           sub AL, AL
fde8:    18 fa        b_gt L_fde4
fdea:    40 35        add CL, BL
