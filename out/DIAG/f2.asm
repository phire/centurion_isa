...
8886:    90 05 a1     ld.w AX, #0x05a1
8889:    50 80        add.w AX, EX
888b:    5c           mov.w DX, AX ; This might be installing an exception handler?
888c:    90 00 10     ld.w AX, #0x0010

L_888f:
888f:    c5 61        ld.b BL, (DX)+
8891:    e5 01        st.b BL, (AX)+
8893:    3f           dec RT
8894:    15 f9        bnz L_888f ; clearing all registers?
8896:    03           fcn
8897:    07           fcc
8898:    c0 01        ld.b BL, #0x01 ; if A is empty. This would set the overflow flag
...
894f:    06           fsc
8950:    02           fsn
8951:    22 60        clr.b DH ; Using 60 in the operand means the following branch will be skipped
...
L_8aa5:
8aa5:    80 00        ld.b AL, #0x00
8aa7:    14 01        bz L_8aaa
8aa9:    00           HALT

L_8aaa:
8aaa:    c0 80        ld.b BL, #0x80
...
L_8ae9:
8ae9:    80 aa        ld.b AL, #0xaa
8aeb:    c0 aa        ld.b BL, #0xaa
8aed:    41 13        sub.b* BL, AL
...
L_8af8:
8af8:    c0 55        ld.b BL, #0x55
8afa:    40 31        add.b AL, BL
...
L_8b06:
8b06:    80 aa        ld.b AL, #0xaa
8b08:    43 31        or.b AL, BL
...
L_8b14:
8b14:    80 55        ld.b AL, #0x55
8b16:    02           fsn
8b17:    06           fsc
8b18:    44 31        xor.b AL, BL
...
L_8b23:
8b23:    90 55 55     ld.w AX, #0x5555
8b26:    d0 55 55     ld.w BX, #0x5555
8b29:    51 02        sub.w BX, AX
...
L_8b34:
8b34:    d0 aa aa     ld.w BX, #0xaaaa
8b37:    50 20        add.w AX, BX
...
L_8b46:
8b46:    90 55 55     ld.w AX, #0x5555
8b49:    53 20        or.w AX, BX
...
L_8b55:
8b55:    90 aa aa     ld.w AX, #0xaaaa
8b58:    06           fsc
8b59:    02           fsn
8b5a:    54 20        xor.w AX, BX
...
L_8b65:
8b65:    90 aa 55     ld.w AX, #0xaa55
8b68:    55 02        mov.w BX, AX
8b6a:    55 04        mov.w RT, AX
8b6c:    55 06        mov.w DX, AX
8b6e:    55 08        mov.w EX, AX
8b70:    55 8a        mov.w SP, EX
8b72:    55 8c        mov.w GX, EX
8b74:    55 80        mov.w AX, EX
8b76:    50 20        add.w AX, BX
8b78:    50 40        add.w AX, RT
8b7a:    50 60        add.w AX, DX
8b7c:    51 08        sub.w EX, AX
8b7e:    51 8a        sub.w SP, EX
8b80:    51 ac        sub.w GX, SP
8b82:    51 c2        sub.w BX, GX
8b84:    14 01        bz L_8b87
8b86:    00           HALT

L_8b87:
8b87:    d0 55 aa     ld.w BX, #0x55aa
8b8a:    44 67        xor.b DL, DH
8b8c:    44 76        xor.b DH, DL
8b8e:    44 67        xor.b DL, DH
8b90:    54 62        xor.w BX, DX
8b92:    14 01        bz L_8b95
8b94:    00           HALT

L_8b95:
8b95:    45 69        mov.b EL, DH
8b97:    45 78        mov.b EH, DL
8b99:    44 c8        xor.b EH, GH
8b9b:    44 d9        xor.b EL, GL
8b9d:    55 88        mov.w EX, EX
8b9f:    14 01        bz L_8ba2
8ba1:    00           HALT

L_8ba2:
8ba2:    90 80 00     ld.w AX, #0x8000
8ba5:    d0 00 01     ld.w BX, #0x0001
8ba8:    59           sub.w! BX, AX
...
L_8bc0:
8bc0:    90 aa aa     ld.w AX, #0xaaaa
8bc3:    d0 55 55     ld.w BX, #0x5555
8bc6:    5e           mov.w EX, AX
8bc7:    5b           or.w! BX, AX
8bc8:    5a           and.w! BX, AX
...
L_8bd0:
8bd0:    55 82        mov.w BX, EX
8bd2:    55 40        mov.w AX, RT
8bd4:    5a           and.w! BX, AX
8bd5:    51 40        sub.w AX, RT
8bd7:    14 01        bz L_8bda
8bd9:    00           HALT

L_8bda:
8bda:    91 bf fc     ld.w AX, (0xbffc)
8bdd:    5e           mov.w EX, AX
8bde:    91 00 26     ld.w AX, (0x0026)
8be1:    14 01        bz L_8be4
8be3:    00           HALT

L_8be4:
8be4:    d1 00 24     ld.w BX, (0x0024)
...
L_8bf0:
8bf0:    b1 00 2c     st.w AX, (0x002c)
8bf3:    14 01        bz L_8bf6
8bf5:    00           HALT

L_8bf6:
8bf6:    91 00 2c     ld.w AX, (0x002c)
8bf9:    f1 00 2c     st.w BX, (0x002c)
8bfc:    16 01        blt L_8bff
8bfe:    00           HALT

L_8bff:
8bff:    d1 00 2c     ld.w BX, (0x002c)
...
L_8c13:
8c13:    91 bf fc     ld.w AX, (0xbffc)
8c16:    5e           mov.w EX, AX
8c17:    91 00 10     ld.w AX, (0x0010)
8c1a:    50 80        add.w AX, EX
8c1c:    b1 00 10     st.w AX, (0x0010)
8c1f:    91 00 12     ld.w AX, (0x0012)
8c22:    50 80        add.w AX, EX
8c24:    b1 00 12     st.w AX, (0x0012)
8c27:    91 00 14     ld.w AX, (0x0014)
8c2a:    50 80        add.w AX, EX
8c2c:    b1 00 14     st.w AX, (0x0014)
8c2f:    91 00 16     ld.w AX, (0x0016)
8c32:    50 80        add.w AX, EX
8c34:    b1 00 16     st.w AX, (0x0016)
8c37:    91 00 18     ld.w AX, (0x0018)
8c3a:    50 80        add.w AX, EX
8c3c:    b1 00 18     st.w AX, (0x0018)
8c3f:    92 00 12     ld.w AX, @(0x0012)
8c42:    18 01        bgt L_8c45
8c44:    00           HALT

L_8c45:
8c45:    d2 00 14     ld.w BX, @(0x0014)
8c48:    16 01        blt L_8c4b
8c4a:    00           HALT

L_8c4b:
8c4b:    54 20        xor.w AX, BX
8c4d:    3b           not.w! AX
8c4e:    14 01        bz L_8c51
8c50:    00           HALT

L_8c51:
8c51:    94 1c        ld.w AX, @(PC+0x1c)
8c53:    18 01        bgt L_8c56
8c55:    00           HALT

L_8c56:
8c56:    d4 19        ld.w BX, @(PC+0x19)
8c58:    16 01        blt L_8c5b
8c5a:    00           HALT

L_8c5b:
8c5b:    54 20        xor.w AX, BX
8c5d:    3b           not.w! AX
8c5e:    14 01        bz L_8c61
8c60:    00           HALT

L_8c61:
8c61:    93 0c        ld.w AX, (PC+0xc)
8c63:    d3 0c        ld.w BX, (PC+0xc)
8c65:    58           add.w! BX, AX
8c66:    90 ff ba     ld.w AX, #0xffba
8c69:    58           add.w! BX, AX
...
8c76:    9a           ld.w AX, (RT)
8c77:    d0 ff ff     ld.w BX, #0xffff
8c7a:    59           sub.w! BX, AX
8c7b:    14 01        bz L_8c7e
8c7d:    00           HALT

L_8c7e:
8c7e:    95 41        ld.w AX, (RT)+
8c80:    3b           not.w! AX
8c81:    14 01        bz L_8c84
8c83:    00           HALT

L_8c84:
8c84:    95 41        ld.w AX, (RT)+
8c86:    d5 41        ld.w BX, (RT)+
8c88:    54 20        xor.w AX, BX
8c8a:    3b           not.w! AX
...
L_8c92:
8c92:    95 42        ld.w AX, -(RT)
8c94:    d5 42        ld.w BX, -(RT)
8c96:    54 20        xor.w AX, BX
8c98:    3b           not.w! AX
8c99:    14 01        bz L_8c9c
8c9b:    00           HALT

L_8c9c:
8c9c:    d0 00 24     ld.w BX, #0x0024
8c9f:    9a           ld.w AX, (RT)
8ca0:    65 28 fe     ld.w RT, -0x2(BX)+
8ca3:    54 40        xor.w AX, RT
8ca5:    14 01        bz L_8ca8
8ca7:    00           HALT

L_8ca8:
8ca8:    95 28 fc     ld.w AX, -0x4(BX)+
8cab:    65 29 02     ld.w RT, +0x2-(BX)
8cae:    50 40        add.w AX, RT
8cb0:    3b           not.w! AX
...
8cc1:    95 44        ld.w AX, unknown_indexed
8cc3:    d0 ff ff     ld.w BX, #0xffff
8cc6:    59           sub.w! BX, AX
8cc7:    14 01        bz L_8cca
8cc9:    00           HALT

L_8cca:
8cca:    95 45        ld.w AX, unknown_indexed
8ccc:    3b           not.w! AX
8ccd:    14 01        bz L_8cd0
8ccf:    00           HALT

L_8cd0:
8cd0:    95 45        ld.w AX, unknown_indexed
8cd2:    d5 45        ld.w BX, unknown_indexed
8cd4:    54 20        xor.w AX, BX
8cd6:    3b           not.w! AX
8cd7:    14 01        bz L_8cda
8cd9:    00           HALT

L_8cda:
8cda:    95 46        ld.w AX, unknown_indexed
8cdc:    d5 46        ld.w BX, unknown_indexed
8cde:    54 20        xor.w AX, BX
8ce0:    3b           not.w! AX
...
8ce7:    95 44        ld.w AX, unknown_indexed
8ce9:    d5 4c fe     ld.w BX, unknown_indexed
8cec:    54 20        xor.w AX, BX
8cee:    3b           not.w! AX
8cef:    14 01        bz L_8cf2
8cf1:    00           HALT

L_8cf2:
8cf2:    95 4c fc     ld.w AX, unknown_indexed
8cf5:    d5 4d 02     ld.w BX, unknown_indexed
8cf8:    50 20        add.w AX, BX
8cfa:    3b           not.w! AX
8cfb:    14 01        bz L_8cfe
8cfd:    00           HALT

L_8cfe:
8cfe:    95 44        ld.w AX, unknown_indexed
8d00:    d5 4e fc     ld.w BX, unknown_indexed
8d03:    54 20        xor.w AX, BX
8d05:    3b           not.w! AX
...
L_8d09:
8d09:    0d           unknown
8d0a:    90 05 0a     ld.w AX, #0x050a
8d0d:    50 80        add.w AX, EX
8d0f:    51 04        sub.w RT, AX
8d11:    14 01        bz L_8d14
8d13:    00           HALT

L_8d14:
8d14:    90 00 3a     ld.w AX, #0x003a
8d17:    5f           mov.w SP, AX
...
L_8d23:
8d23:    95 41        ld.w AX, (RT)+
8d25:    d0 01 01     ld.w BX, #0x0101
8d28:    54 20        xor.w AX, BX
8d2a:    14 01        bz L_8d2d
8d2c:    00           HALT

L_8d2d:
8d2d:    9d           ld.w AX, (SP)
8d2e:    d0 20 20     ld.w BX, #0x2020
8d31:    54 20        xor.w AX, BX
...
8d3b:    90 11 ff     ld.w AX, #0x11ff
8d3e:    b5 41        st.w AX, (RT)+
8d40:    55 42        mov.w BX, RT
8d42:    90 09 f1     ld.w AX, #0x09f1
8d45:    59           sub.w! BX, AX
...
8d4c:    95 41        ld.w AX, (RT)+
8d4e:    d0 11 ff     ld.w BX, #0x11ff
8d51:    41 02        sub.b BH, AH
...
L_8d70:
8d70:    81 f2 00     ld.b AL, (0xf200)
8d73:    2c           srl.b! AL
8d74:    11 18        bnc L_8d8e
8d76:    81 f2 01     ld.b AL, (0xf201)
8d79:    c0 80        ld.b BL, #0x80
8d7b:    43 31        or.b AL, BL
8d7d:    c0 83        ld.b BL, #0x83
8d7f:    49           sub.b! BL, AL
8d80:    15 0c        bnz L_8d8e
8d82:    61 bf fe     ld.w RT, (0xbffe)
8d85:    91 bf fc     ld.w AX, (0xbffc)
8d88:    d0 07 74     ld.w BX, #0x0774
8d8b:    58           add.w! BX, AX
8d8c:    75 20        jump (A + 0x20)

L_8d8e:
8d8e:    a1 f1 0a     st.b AL, (0xf10a)
8d91:    90 bf fc     ld.w AX, #0xbffc
8d94:    5f           mov.w SP, AX
8d95:    95 a1        ld.w AX, (SP)+
8d97:    5e           mov.w EX, AX
8d98:    65 a1        ld.w RT, (SP)+
8d9a:    90 00 7d     ld.w AX, #0x007d
8d9d:    50 80        add.w AX, EX
...
8dbb:    90 07 cc     ld.w AX, #0x07cc
8dbe:    50 80        add.w AX, EX
...
8df5:    90 07 cc     ld.w AX, #0x07cc
8df8:    50 80        add.w AX, EX
8dfa:    7d 00        call (A + 0x00)
8dfc:    "\r\n*** THIS TEST WILL NOT RUN ON CPU-5 ***\r\n\0"
8e28:    90 07 8a     ld.w AX, #0x078a
8e2b:    50 80        add.w AX, EX
8e2d:    75 00        jump (A + 0x00) ; Press Space to Exit

MappingRamTestLoop:
8e2f:    90 06 d9     ld.w AX, #0x06d9
8e32:    50 80        add.w AX, EX
...
8e59:    a1 f1 0a     st.b AL, (0xf10a)
8e5c:    81 f2 00     ld.b AL, (0xf200)
8e5f:    2c           srl.b! AL
8e60:    11 cd        bnc MappingRamTestLoop

ReturnAddress:
8e62:    81 f2 01     ld.b AL, (0xf201)
8e65:    c0 80        ld.b BL, #0x80
8e67:    43 31        or.b AL, BL
8e69:    c0 83        ld.b BL, #0x83
8e6b:    49           sub.b! BL, AL
8e6c:    15 c1        bnz MappingRamTestLoop
8e6e:    90 07 74     ld.w AX, #0x0774
8e71:    50 80        add.w AX, EX
8e73:    75 00        jump (A + 0x00)

L_8e75:
8e75:    3a           clr.w! AX
8e76:    85 41        ld.b AL, (RT)+
...
nextMemoryLcation:
8e85:    d0 01 00     ld.w BX, #0x0100

nextByteValue:
8e88:    8b           ld.b AL, (DX) ; EF = 0x120 or 0x140 etc
8e89:    28           inc.b! AL
8e8a:    ab           st.b AL, (DX)
8e8b:    ac           st.b AL, (EX) ; HL is EF+0x100
...
8e99:    31 20        dec.w BX ; Test every single byte pattern
...
8eb1:    80 01        ld.b AL, #0x01

L_8eb3:
8eb3:    a5 a2        st.b AL, -(SP)
8eb5:    2a           clr.b! AL
8eb6:    a5 a2        st.b AL, -(SP)
8eb8:    6d a2        st.w RT, -(SP)
8eba:    a5 a2        st.b AL, -(SP)
8ebc:    60 06 c2     ld.w RT, #0x06c2
8ebf:    50 84        add.w RT, EX
8ec1:    0f           unknown
...
8f31:    90 07 cc     ld.w AX, #0x07cc
8f34:    50 80        add.w AX, EX
8f36:    7d 00        call (A + 0x00)
8f38:    "\r\n*** MAP RAM ERROR ***\r\n\0"
8f52:    a1 f1 0b     st.b AL, (0xf10b)
8f55:    a1 f1 0c     st.b AL, (0xf10c)
8f58:    90 07 8a     ld.w AX, #0x078a
8f5b:    50 80        add.w AX, EX
8f5d:    75 00        jump (A + 0x00)

Entry_ROM_SELF_TEST:
8f5f:    55 86        mov.w DX, EX
8f61:    3a           clr.w! AX

ChecksumLoop:
8f62:    85 61        ld.b AL, (DX)+ ; Load Byte via base+index, post-increment index
8f64:    40 10        add.b AH, AL
8f66:    d0 07 dd     ld.w BX, #0x07dd
8f69:    50 82        add.w BX, EX
8f6b:    51 62        sub.w BX, DX
8f6d:    15 f3        bnz ChecksumLoop
8f6f:    8b           ld.b AL, (DX) ; Load Byte via base+index
8f70:    41 01        sub.b AL, AH
8f72:    15 32        bnz ChecksumFail

PrintPassedAndExit:
8f74:    7b 56        call (PC+0x56) WriteString
8f76:    "\r\n*** PASS ***\r\n\0"
8f87:    a1 f1 0a     st.b AL, (0xf10a)
...
WaitForKey:
8f9b:    81 f2 00     ld.b AL, (0xf200)
8f9e:    2c           srl.b! AL
8f9f:    11 fa        bnc WaitForKey
8fa1:    81 f2 01     ld.b AL, (0xf201)
8fa4:    75 40        jump (A + 0x40)

ChecksumFail:
8fa6:    7b 24        call (PC+0x24) WriteString
8fa8:    "\r\n*** CHECK SUM ERROR ***\r\n\0"
8fc4:    a1 f1 0b     st.b AL, (0xf10b)
8fc7:    a1 f1 0c     st.b AL, (0xf10c)
8fca:    73 be        jump (PC-0x42) L_8f8a

WriteString:
8fcc:    81 f2 00     ld.b AL, (0xf200)
8fcf:    2c           srl.b! AL
8fd0:    2c           srl.b! AL
8fd1:    11 f9        bnc WriteString
8fd3:    85 41        ld.b AL, (RT)+
8fd5:    15 01        bnz L_8fd8
8fd7:    09           ret

L_8fd8:
8fd8:    a1 f2 01     st.b AL, (0xf201)
