...
8889:    50 80        add A, E
888b:    5c           shift_right A, B ; This might be installing an exception handler?
888c:    90 00 10     liw A, 0x0010

L_888f:
888f:    c5 61        unknown
8891:    e5 01        unknown
8893:    3f           rotate_left A, A
...
L_88f9:
88f9:    2a           xor AL, AL ; This is potentially increment, 
...
894f:    06           flag6
8950:    02           flag2
8951:    22 60        xor AH, DH ; Using 60 in the operand means the following branch will be skipped
...
L_89c1:
89c1:    22 b0        xor AH, FL ; Is B0 a two byte instrution that we haven't encountered yet?
89c3:    23 b0        or AH, FL
...
L_8a6c:
8a6c:    3e           rotate_right A, A
8a6d:    18 01        b_gt L_8a70
8a6f:    00           HALT

L_8a70:
8a70:    3f           rotate_left A, A
8a71:    14 01        b_z L_8a74
8a73:    00           HALT

L_8a74:
8a74:    3f           rotate_left A, A
8a75:    16 01        b_lt L_8a78
8a77:    00           HALT

L_8a78:
8a78:    3e           rotate_right A, A
...
8b8a:    44 67        shift_right DL, DH
8b8c:    44 76        shift_right DH, DL
8b8e:    44 67        shift_right DL, DH
8b90:    54 62        shift_right B, D
8b92:    14 01        b_z L_8b95
8b94:    00           HALT

L_8b95:
8b95:    45 69        mov EL, DH
8b97:    45 78        mov EH, DL
8b99:    44 c8        shift_right EH, GH
8b9b:    44 d9        shift_right EL, GL
8b9d:    55 88        mov E, E
...
8d31:    54 20        shift_right A, B
8d33:    14 01        b_z L_8d36
8d35:    00           HALT

L_8d36:
8d36:    3e           rotate_right A, A
8d37:    09           ret
...
8d5d:    2f           rotate_left AL, AL
8d5e:    00           HALT
8d5f:    2f           rotate_left AL, AL
8d60:    21 59        sub EL, CL
8d62:    14 01        b_z L_8d65
8d64:    00           HALT

L_8d65:
8d65:    90 46 11     liw A, 0x4611
8d68:    2f           rotate_left AL, AL
8d69:    02           flag2
8d6a:    2f           rotate_left AL, AL
8d6b:    23 59        or EL, CL
...
8d94:    5f           rotate_left A, B
8d95:    95 a1        unknown
8d97:    5e           rotate_right A, B
8d98:    65 a1        unknown
...
8e76:    85 41        ldb A, [sp]++
8e78:    35 04        mov C, A
8e7a:    20 00        add AH, AH
8e7c:    7e           unknown
8e7d:    45 5c        mov GH, CL
8e7f:    5e           rotate_right A, B
8e80:    20 80        add AH, EH
...
8e9d:    30 60        add A, D
8e9f:    30 80        add A, E
8ea1:    3f           rotate_left A, A

L_8ea2:
8ea2:    15 e1        b_nz L_8e85
8ea4:    7f           unknown
8ea5:    45 09        mov EL, AH

L_8ea7:
8ea7:    2e           rotate_right AL, AL
8ea8:    1c f8        b_sense2 L_8ea2
8eaa:    03           flag3
8eab:    00           HALT
8eac:    2e           rotate_right AL, AL
8ead:    0c           unknown
8eae:    f9           unknown
8eaf:    03           flag3
8eb0:    00           HALT
...
L_8ecc:
8ecc:    2e           rotate_right AL, AL
8ecd:    1c f9        b_sense2 L_8ec8
8ecf:    03           flag3
8ed0:    00           HALT
8ed1:    2e           rotate_right AL, AL
8ed2:    0c           unknown
8ed3:    f8           unknown
...
Fn_6d9:
8ed9:    2e           rotate_right AL, AL

L_8eda:
8eda:    1c f8        b_sense2 L_8ed4
8edc:    01           nop
8edd:    00           HALT
8ede:    2e           rotate_right AL, AL
8edf:    1c f9        b_sense2 L_8eda
8ee1:    01           nop
8ee2:    20 2e        add HH, BH
8ee4:    1c fa        b_sense2 L_8ee0

L_8ee6:
8ee6:    01           nop
8ee7:    40 2e        add HH, BH
...
L_8f04:
8f04:    2e           rotate_right AL, AL
8f05:    0c           unknown
8f06:    f8           unknown
8f07:    01           nop
8f08:    00           HALT
8f09:    2e           rotate_right AL, AL
8f0a:    0c           unknown
8f0b:    f9           unknown
8f0c:    01           nop
8f0d:    20 2e        add HH, BH
8f0f:    0c           unknown
8f10:    fa           unknown
8f11:    01           nop
8f12:    40 2e        add HH, BH
8f14:    0c           unknown
8f15:    fb           unknown
8f16:    01           nop
