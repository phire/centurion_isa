...
9964:    5f           rotate_left A, B
9965:    91 01 1a     ldw A, 0x011a
9968:    5e           rotate_right A, B
9969:    95 41        unknown
996b:    50 80        add A, E
...
9a9a:    2c           shift_right AL, AL
9a9b:    2c           shift_right AL, AL
9a9c:    11 2d        b1 L_9acb
9a9e:    0e           delay 4.5ms
9a9f:    3f           rotate_left A, A
...
9af2:    28           add AL, AL
9af3:    28           add AL, AL
9af4:    3f           rotate_left A, A
9af5:    15 f8        b_nz L_9aef
9af7:    90 f0 ff     liw A, 0xf0ff
9afa:    2f           rotate_left AL, AL
9afb:    02           flag2
9afc:    90 01 1c     liw A, 0x011c
9aff:    2f           rotate_left AL, AL
9b00:    00           HALT
9b01:    2f           rotate_left AL, AL
9b02:    34 2f        shift_right {HL, LH}, B
9b04:    06           flag6
...
L_9b32:
9b32:    a5 21        unknown
9b34:    3f           rotate_left A, A
9b35:    15 fb        b_nz L_9b32
9b37:    90 f0 ff     liw A, 0xf0ff
9b3a:    2f           rotate_left AL, AL
9b3b:    02           flag2
9b3c:    90 01 1c     liw A, 0x011c
9b3f:    2f           rotate_left AL, AL
9b40:    00           HALT
9b41:    2f           rotate_left AL, AL
9b42:    34 2f        shift_right {HL, LH}, B
9b44:    06           flag6
...
9b7e:    20 00        add AH, AH
9b80:    20 00        add AH, AH
9b82:    20 00        add AH, AH
9b84:    3f           rotate_left A, A

L_9b85:
9b85:    15 f0        b_nz L_9b77
9b87:    95 a1        unknown
9b89:    20 70        add AH, DL
...
9bf4:    2f           rotate_left AL, AL

L_9bf5:
9bf5:    02           flag2
9bf6:    90 41 4d     liw A, 0x414d
9bf9:    2f           rotate_left AL, AL
9bfa:    00           HALT
9bfb:    2f           rotate_left AL, AL
9bfc:    34 2f        shift_right {HL, LH}, B
9bfe:    06           flag6
...
9c35:    2f           rotate_left AL, AL
9c36:    00           HALT
9c37:    90 ff f7     liw A, 0xfff7
9c3a:    2f           rotate_left AL, AL
9c3b:    02           flag2
9c3c:    2f           rotate_left AL, AL
9c3d:    34 2f        shift_right {HL, LH}, B
9c3f:    06           flag6
...
L_9c7f:
9c7f:    36 59        rotate_right {EL, FH}, {CL, DH}
...
L_9cca:
9cca:    b5 61        unknown
9ccc:    20 30        add AH, BL
9cce:    21 20        sub AH, BH
...
9cd8:    2f           rotate_left AL, AL
9cd9:    02           flag2
9cda:    90 41 4d     liw A, 0x414d
9cdd:    2f           rotate_left AL, AL
9cde:    00           HALT
9cdf:    2f           rotate_left AL, AL
9ce0:    34 2f        shift_right {HL, LH}, B
9ce2:    06           flag6
...
L_9cff:
9cff:    00           HALT
9d00:    2f           rotate_left AL, AL
9d01:    34 2f        shift_right {HL, LH}, B
9d03:    06           flag6
...
9d5c:    2f           rotate_left AL, AL

L_9d5d:
9d5d:    02           flag2
9d5e:    90 41 4d     liw A, 0x414d
9d61:    2f           rotate_left AL, AL
9d62:    00           HALT

L_9d63:
9d63:    2f           rotate_left AL, AL
9d64:    34 2f        shift_right {HL, LH}, B
9d66:    06           flag6
...
9d9d:    2f           rotate_left AL, AL
9d9e:    00           HALT
9d9f:    90 ff f7     liw A, 0xfff7
9da2:    2f           rotate_left AL, AL
9da3:    02           flag2
9da4:    2f           rotate_left AL, AL
9da5:    34 2f        shift_right {HL, LH}, B
9da7:    06           flag6
...
9e2e:    20 30        add AH, BL
9e30:    21 20        sub AH, BH
...
9e3a:    2f           rotate_left AL, AL
9e3b:    02           flag2
9e3c:    90 41 4d     liw A, 0x414d
9e3f:    2f           rotate_left AL, AL
9e40:    00           HALT
9e41:    2f           rotate_left AL, AL
9e42:    34 2f        shift_right {HL, LH}, B
9e44:    06           flag6
...
L_9e61:
9e61:    00           HALT
9e62:    2f           rotate_left AL, AL
9e63:    34 2f        shift_right {HL, LH}, B
9e65:    06           flag6
