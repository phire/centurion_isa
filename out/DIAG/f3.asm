...
90a6:    24 30        shift_right AH
90a8:    24 30        shift_right AH
...
WriteHexByte:
90c5:    a5 a2        mov [--SP], AL
90c7:    c0 f0        mov BL, 0xf0
90c9:    42 31        and AL, BL
90cb:    07           clear_carry
90cc:    26 10        rotate_right AH
90ce:    2c           shift_right AL
90cf:    2c           shift_right AL
90d0:    2c           shift_right AL
...
91dc:    65 a1        mov r2, [SP++]
91de:    69 01 00     mov [0x0100], r2
91e1:    75 00        jump A + 0x00

Fn_1e3:
91e3:    7a 01 0c     call [0x010c]
91e6:    6d a2        mov [--SP], r2
91e8:    60 03 e8     mov r2, 0x03e8

L_91eb:
91eb:    82 01 16     mov AL, [[0x0116]]
91ee:    c0 08        mov BL, 0x08
91f0:    4a           and BL, AL
91f1:    14 2b        b_z L_921e
91f3:    0e           delay 4.5ms
91f4:    3f           rotate_left AX
...
L_921e:
921e:    60 03 e8     mov r2, 0x03e8

L_9221:
9221:    2c           shift_right AL
9222:    10 2b        b0 L_924f
9224:    0e           delay 4.5ms
9225:    3f           rotate_left AX
...
L_924f:
924f:    03           flag3
9250:    82 01 14     mov AL, [[0x0114]]
9253:    15 03        b_nz L_9258
9255:    65 a1        mov r2, [SP++]
9257:    09           ret

L_9258:
9258:    a5 a2        mov [--SP], AL
...
9282:    65 a1        mov r2, [SP++]
9284:    02           flag2
9285:    09           ret

Fn_286:
9286:    6d a2        mov [--SP], r2
9288:    0e           delay 4.5ms
9289:    60 03 e8     mov r2, 0x03e8

L_928c:
928c:    82 01 16     mov AL, [[0x0116]]
928f:    2c           shift_right AL
9290:    2c           shift_right AL
9291:    11 2d        b1 L_92c0
9293:    0e           delay 4.5ms
9294:    3f           rotate_left AX
9295:    15 f5        b_nz L_928c
9297:    7a 01 12     call [0x0112]
929a:    "*** FIN DID NOT GO OFF ***\r\n\0"
92b7:    a1 f1 0b     mov [0xf10b], AL
92ba:    a1 f1 0c     mov [0xf10c], AL
92bd:    72 01 0e     jump [0x010e] ;

L_92c0:
92c0:    65 a1        mov r2, [SP++]
92c2:    09           ret
92c3:    90
92c4:    01
92c5:    80
...
92d5:    f8           mov single_byte[AX], BX
92d6:    00           HALT
92d7:    7a 01 06     call [0x0106]
92da:    32 60        clear AX
92dc:    60 00 c8     mov r2, 0x00c8
...
92fc:    a2 01 14     mov [[0x0114]], AL
92ff:    7a 01 18     call [0x0118]
9302:    60 00 e6     mov r2, 0x00e6
9305:    3a           clear AX
9306:    d0 01 1c     mov BX, 0x011c

L_9309:
9309:    a5 21        mov [--BX], AL
930b:    3f           rotate_left AX
...
931e:    a2 01 14     mov [[0x0114]], AL
9321:    7a 01 18     call [0x0118]
9324:    60 00 c8     mov r2, 0x00c8
...
9336:    20 00        inc? AH
9338:    20 00        inc? AH
933a:    3f           rotate_left AX
933b:    15 f1        b_nz L_932e
933d:    20 70        inc? AH
933f:    7a 01 04     call [0x0104]
9342:    02           flag2
9343:    da           mov BX, single_byte[r2]
...
9374:    f8           mov single_byte[AX], BX
9375:    08           flag8
9376:    7a 01 06     call [0x0106]
9379:    32 60        clear AX
937b:    60 3f ff     mov r2, 0x3fff
...
93db:    a2 01 14     mov [[0x0114]], AL
93de:    7a 01 0c     call [0x010c]
93e1:    2a           clear AL
93e2:    a2 01 14     mov [[0x0114]], AL
93e5:    7a 01 0c     call [0x010c]
93e8:    2a           clear AL
93e9:    a2 01 14     mov [[0x0114]], AL
93ec:    7a 01 0c     call [0x010c]
93ef:    80 3f        mov AL, 0x3f
93f1:    a2 01 14     mov [[0x0114]], AL
93f4:    7a 01 0c     call [0x010c]
93f7:    80 ff        mov AL, 0xff
93f9:    a2 01 14     mov [[0x0114]], AL
93fc:    7a 01 18     call [0x0118]
93ff:    b5 a2        mov [--SP], AX
9401:    60 3f ff     mov r2, 0x3fff
...
940d:    bd           mov single_byte[SP], AX
940e:    41 01        sub AL, AH
9410:    15 12        b_nz L_9424
9412:    20 00        inc? AH
9414:    20 00        inc? AH
9416:    20 00        inc? AH
9418:    3f           rotate_left AX
...
Entry_CMD_SEEK_TEST:
946d:    90 01 80     mov AX, 0x0180
9470:    50 80        add AX, r4
9472:    7d 00        call A + 0x00
9474:    f8           mov single_byte[AX], BX
9475:    08           flag8
...
9495:    a2 01 14     mov [[0x0114]], AL
9498:    7a 01 18     call [0x0118]
949b:    13 09        b3 L_94a6

L_949d:
949d:    a1 f1 0b     mov [0xf10b], AL
94a0:    a1 f1 0c     mov [0xf10c], AL
94a3:    72 01 0e     jump [0x010e] ;

L_94a6:
94a6:    80 45        mov AL, 0x45
94a8:    a2 01 14     mov [[0x0114]], AL
...
9533:    80 50        mov AL, 0x50
9535:    80 7d        mov AL, 0x7d
9537:    00           HALT
9538:    f8           mov single_byte[AX], BX
9539:    08           flag8
953a:    7a 01 06     call [0x0106]
953d:    80 41        mov AL, 0x41
953f:    a2 01 14     mov [[0x0114]], AL
9542:    7a 01 0c     call [0x010c]
9545:    2a           clear AL
9546:    a2 01 14     mov [[0x0114]], AL
9549:    7a 01 0c     call [0x010c]
954c:    2a           clear AL
954d:    a2 01 14     mov [[0x0114]], AL
9550:    7a 01 18     call [0x0118]
9553:    12 44        b2 L_9599
9555:    90 41 4d     mov AX, 0x414d
9558:    5c           xor BX, AX
...
96a1:    00           HALT
96a2:    f8           mov single_byte[AX], BX
96a3:    00           HALT
96a4:    7a 01 06     call [0x0106]
96a7:    80 41        mov AL, 0x41
96a9:    a2 01 14     mov [[0x0114]], AL
96ac:    7a 01 0c     call [0x010c]
96af:    2a           clear AL
96b0:    a2 01 14     mov [[0x0114]], AL
96b3:    7a 01 0c     call [0x010c]
96b6:    2a           clear AL
96b7:    a2 01 14     mov [[0x0114]], AL
96ba:    7a 01 18     call [0x0118]
96bd:    12 3d        b2 L_96fc
96bf:    90 41 4d     mov AX, 0x414d
96c2:    5c           xor BX, AX
96c3:    90 81 01     mov AX, 0x8101
96c6:    b5 61        mov [--r3], AX
96c8:    90 83 01     mov AX, 0x8301
...
L_9733:
9733:    81 41 50     mov AL, [0x4150]
9736:    2d           shift_left AL
