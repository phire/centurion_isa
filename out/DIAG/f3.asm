...
9159:    5f           rotate_left A, B
915a:    91 01 1a     ldw A, 0x011a
915d:    5e           rotate_right A, B
915e:    95 41        unknown
9160:    50 80        add A, E
...
928f:    2c           shift_right AL, AL
9290:    2c           shift_right AL, AL
9291:    11 2d        b1 L_92c0
9293:    0e           delay 4.5ms
9294:    3f           rotate_left A, A
...
92e7:    28           add AL, AL
92e8:    28           add AL, AL
92e9:    3f           rotate_left A, A
92ea:    15 f8        b_nz L_92e4
92ec:    90 ff 37     liw A, 0xff37
92ef:    2f           rotate_left AL, AL
92f0:    02           flag2
92f1:    90 01 1c     liw A, 0x011c
92f4:    2f           rotate_left AL, AL
92f5:    00           HALT
92f6:    2f           rotate_left AL, AL
92f7:    34 2f        shift_right {HL, LH}, B
92f9:    06           flag6
...
L_9309:
9309:    a5 21        unknown
930b:    3f           rotate_left A, A
930c:    15 fb        b_nz L_9309
930e:    90 ff 37     liw A, 0xff37
9311:    2f           rotate_left AL, AL
9312:    02           flag2
9313:    90 01 1c     liw A, 0x011c
9316:    2f           rotate_left AL, AL
9317:    00           HALT
9318:    2f           rotate_left AL, AL
9319:    34 2f        shift_right {HL, LH}, B
931b:    06           flag6
...
9334:    20 00        add AH, AH
9336:    20 00        add AH, AH
9338:    20 00        add AH, AH
933a:    3f           rotate_left A, A
933b:    15 f1        b_nz L_932e
933d:    20 70        add AH, DL
...
9386:    28           add AL, AL
9387:    28           add AL, AL
9388:    3f           rotate_left A, A
9389:    15 f8        b_nz L_9383
938b:    90 c0 00     liw A, 0xc000
938e:    2f           rotate_left AL, AL
938f:    02           flag2
9390:    90 01 1c     liw A, 0x011c
9393:    2f           rotate_left AL, AL
9394:    00           HALT
9395:    2f           rotate_left AL, AL
9396:    34 2f        shift_right {HL, LH}, B
9398:    06           flag6
...
L_93c6:
93c6:    a5 21        unknown
93c8:    3f           rotate_left A, A
93c9:    15 fb        b_nz L_93c6
93cb:    90 c0 00     liw A, 0xc000
93ce:    2f           rotate_left AL, AL
93cf:    02           flag2
93d0:    90 01 1c     liw A, 0x011c
93d3:    2f           rotate_left AL, AL
93d4:    00           HALT
93d5:    2f           rotate_left AL, AL
93d6:    34 2f        shift_right {HL, LH}, B
93d8:    06           flag6
...
9412:    20 00        add AH, AH
9414:    20 00        add AH, AH
9416:    20 00        add AH, AH
9418:    3f           rotate_left A, A

L_9419:
9419:    15 f0        b_nz L_940b
941b:    95 a1        unknown
941d:    20 70        add AH, DL
...
9488:    2f           rotate_left AL, AL

L_9489:
9489:    02           flag2
948a:    90 41 4d     liw A, 0x414d
948d:    2f           rotate_left AL, AL
948e:    00           HALT
948f:    2f           rotate_left AL, AL
9490:    34 2f        shift_right {HL, LH}, B
9492:    06           flag6
...
94c9:    2f           rotate_left AL, AL
94ca:    00           HALT
94cb:    90 ff f7     liw A, 0xfff7
94ce:    2f           rotate_left AL, AL
94cf:    02           flag2
94d0:    2f           rotate_left AL, AL
94d1:    34 2f        shift_right {HL, LH}, B
94d3:    06           flag6
...
L_9513:
9513:    36 59        rotate_right {EL, FH}, {CL, DH}
...
L_9554:
9554:    44 90        shift_right AH, EL
9556:    41 4d        sub GL, CH
9558:    5c           shift_right A, B
...
9576:    b5 61        unknown
9578:    20 30        add AH, BL
957a:    21 20        sub AH, BH
...
9584:    2f           rotate_left AL, AL
9585:    02           flag2
9586:    90 41 4d     liw A, 0x414d
9589:    2f           rotate_left AL, AL
958a:    00           HALT
958b:    2f           rotate_left AL, AL
958c:    34 2f        shift_right {HL, LH}, B
958e:    06           flag6
...
L_95ab:
95ab:    00           HALT
95ac:    2f           rotate_left AL, AL
95ad:    34 2f        shift_right {HL, LH}, B
95af:    06           flag6
...
9602:    2f           rotate_left AL, AL
9603:    02           flag2
9604:    90 41 4d     liw A, 0x414d
9607:    2f           rotate_left AL, AL
9608:    00           HALT
9609:    2f           rotate_left AL, AL
960a:    34 2f        shift_right {HL, LH}, B
960c:    06           flag6
...
9639:    2f           rotate_left AL, AL
963a:    00           HALT
963b:    90 ff fb     liw A, 0xfffb
963e:    2f           rotate_left AL, AL
963f:    02           flag2
9640:    2f           rotate_left AL, AL
9641:    34 2f        shift_right {HL, LH}, B
9643:    06           flag6
...
96dc:    b5 61        unknown
96de:    20 30        add AH, BL
96e0:    21 20        sub AH, BH
96e2:    15 ec        b_nz L_96d0

L_96e4:
96e4:    90 ff ab     liw A, 0xffab
96e7:    2f           rotate_left AL, AL
96e8:    02           flag2
96e9:    90 41 4d     liw A, 0x414d
96ec:    2f           rotate_left AL, AL
96ed:    00           HALT
96ee:    2f           rotate_left AL, AL
96ef:    34 2f        shift_right {HL, LH}, B
96f1:    06           flag6
...
L_970e:
970e:    00           HALT
970f:    2f           rotate_left AL, AL
9710:    34 2f        shift_right {HL, LH}, B
9712:    06           flag6
