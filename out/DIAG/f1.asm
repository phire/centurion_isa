...
804a:    3d           shift_left AX
804b:    d0 80 55     mov BX, 0x8055
804e:    58           add BX, AX
804f:    99           mov AX, single_byte[BX]
...
8077:    2d           shift_left AL
8078:    2d           shift_left AL
8079:    2d           shift_left AL
807a:    2d           shift_left AL
...
Test02_Vector:
8171:    c0 04        mov BL, 0x04
8173:    49           sub BL, AL
8174:    14 03        b_z L_8179
8176:    71 80 77     jump 0x8077 Fail

L_8179:
8179:    80 f0        mov AL, 0xf0
817b:    42 81        and AL, r4_high
817d:    28           inc? AL
817e:    28           inc? AL
817f:    4d           mov BL, AL
...
Test03_Vector:
81a3:    55 c4        mov r2, r6
81a5:    0a           reti

L_81a6:
81a6:    60 00 10     mov r2, 0x0010

L_81a9:
81a9:    95 48        mov AX, [r2++]
81ab:    04           EI
...
81f5:    2c           shift_right AL
81f6:    2c           shift_right AL
...
8234:    3e           rotate_right AX
8235:    09           ret

L_8236:
8236:    45 31        mov AL, BL
8238:    2d           shift_left AL
8239:    2d           shift_left AL
823a:    c5 41        mov BL, [r2++]
823c:    48           add BL, AL
...
Test06_Vector:
826f:    81 f2 0f     mov AL, [0xf20f]
8272:    15 0d        b_nz L_8281
8274:    91 f2 00     mov AX, [0xf200]
8277:    a1 f2 01     mov [0xf201], AL
827a:    91 00 0a     mov AX, [0x000a]
827d:    5f           mov SP, AX
...
82f1:    3d           shift_left AX
82f2:    3d           shift_left AX
82f3:    3d           shift_left AX
82f4:    3d           shift_left AX
...
L_8307:
8307:    3e           rotate_right AX
8308:    3e           rotate_right AX
8309:    90 03 2c     mov AX, 0x032c
830c:    51 40        sub AX, r2
830e:    15 df        b_nz L_82ef
8310:    3f           rotate_left AX
8311:    3f           rotate_left AX

L_8312:
8312:    55 40        mov AX, r2
8314:    3d           shift_left AX
8315:    3d           shift_left AX
8316:    3d           shift_left AX
8317:    3d           shift_left AX
...
L_832a:
832a:    3f           rotate_left AX
832b:    3f           rotate_left AX
832c:    17 e4        b7 L_8312
832e:    a1 f1 0a     mov [0xf10a], AL
8331:    73 b0        jump Test_08

L_8333:
8333:    2d           shift_left AL
8334:    2d           shift_left AL
8335:    2d           shift_left AL
8336:    2d           shift_left AL
...
83b6:    2d           shift_left AL
83b7:    2d           shift_left AL
83b8:    2d           shift_left AL
83b9:    2d           shift_left AL
...
8626:    2c           shift_right AL
8627:    2c           shift_right AL
...
L_86e5:
86e5:    8a           mov AL, single_byte[r2]
86e6:    41 51        sub AL, r2_low
86e8:    15 3a        b_nz L_8724
86ea:    3e           rotate_right AX
86eb:    31 20        dec? AX
...
L_8702:
8702:    8a           mov AL, single_byte[r2]
8703:    2b           neg? AL
8704:    41 51        sub AL, r2_low
8706:    15 1c        b_nz L_8724
8708:    3e           rotate_right AX
8709:    31 20        dec? AX
...
87c7:    35 40        shift_left AX
87c9:    35 40        shift_left AX
87cb:    35 40        shift_left AX
87cd:    35 40        shift_left AX
...
87e0:    3d           shift_left AX
87e1:    3b           neg? AX
87e2:    38           inc? AX
87e3:    d0 c0 00     mov BX, 0xc000
87e6:    50 20        add AX, BX
87e8:    98           mov AX, single_byte[AX]
87e9:    55 2a        mov SP, BX
87eb:    60 80 01     mov r2, 0x8001
