...
8013:    5f           rotate_left A, B ; Set stack pointer just beyond top of Diag's 1KB of RAM
8014:    22 32        xor BH, BL
...
803f:    49           sub AL, BL ; Compare with 0b1011
...
8092:    2f           rotate_left AL, AL
8093:    42 2f        xor HL, BH
8095:    03           flag3
8096:    51 40        sub A, C
8098:    15 43        b_nz L_80dd
809a:    c0 21        lib B, 0x21
809c:    2f           rotate_left AL, AL
809d:    40 2f        add HL, BH
809f:    01           nop
80a0:    51 40        sub A, C
80a2:    15 39        b_nz L_80dd
80a4:    20 50        add AH, CL
80a6:    20 40        add AH, CH
80a8:    15 e6        b_nz L_8090
80aa:    90 00 12     liw A, 0x0012
80ad:    5c           shift_right A, B

L_80ae:
80ae:    55 60        mov A, D
80b0:    bb           unknown
80b1:    20 70        add AH, DL
80b3:    20 70        add AH, DL
80b5:    15 f7        b_nz L_80ae
80b7:    90 00 12     liw A, 0x0012
80ba:    5c           shift_right A, B
...
L_80c6:
80c6:    20 70        add AH, DL
80c8:    20 70        add AH, DL
...
L_8286:
8286:    55 46        mov D, C
8288:    45 51        mov AL, CL
828a:    a1 f1 40     stb A, 0xf140
828d:    28           add AL, AL
...
L_8307:
8307:    3e           rotate_right A, A
8308:    3e           rotate_right A, A
8309:    90 03 2c     liw A, 0x032c
830c:    51 40        sub A, C
830e:    15 df        b_nz L_82ef
8310:    3f           rotate_left A, A
8311:    3f           rotate_left A, A
...
L_832a:
832a:    3f           rotate_left A, A
832b:    3f           rotate_left A, A
...
8392:    2f           rotate_left AL, AL
8393:    02           flag2
8394:    90 01 00     liw A, 0x0100
8397:    2f           rotate_left AL, AL
8398:    00           HALT
8399:    2f           rotate_left AL, AL
839a:    04           flag4
839b:    2f           rotate_left AL, AL
839c:    06           flag6
839d:    2a           xor AL, AL
...
83ff:    2f           rotate_left AL, AL
8400:    02           flag2
8401:    90 01 00     liw A, 0x0100
8404:    2f           rotate_left AL, AL
8405:    00           HALT
8406:    2f           rotate_left AL, AL
8407:    06           flag6
8408:    2a           xor AL, AL
...
84ce:    55 0c        mov G, A
84d0:    95 22        unknown
84d2:    5f           rotate_left A, B
84d3:    95 22        unknown
84d5:    5e           rotate_right A, B
84d6:    95 22        unknown
84d8:    5c           shift_right A, B
84d9:    65 22        unknown
...
L_84e7:
84e7:    8b 7b        unknown
84e9:    2f           rotate_left AL, AL

L_84ea:
84ea:    7b 4e        call ReadHexWord
84ec:    45 91        mov AL, EL
84ee:    c1 bf 92     ldb B, 0xbf92
...
WriteHexNibble:
8520:    22 00        xor AH, AH
8522:    36 00        rotate_right A, A
8524:    36 00        rotate_right A, A
8526:    36 00        rotate_right A, A
8528:    36 00        rotate_right A, A
...
85f0:    f5 a2        unknown
85f2:    2f           rotate_left AL, AL
85f3:    14 2f        b_z L_8624
85f5:    06           flag6
85f6:    2f           rotate_left AL, AL
85f7:    a0           unknown
85f8:    90 ff f6     liw A, 0xfff6
85fb:    2f           rotate_left AL, AL
85fc:    02           flag2
85fd:    7b 22        call L_8621
85ff:    43 90        or AH, EL
8601:    01           nop
8602:    00           HALT
8603:    2f           rotate_left AL, AL
8604:    00           HALT
8605:    90 f0 ff     liw A, 0xf0ff
8608:    2f           rotate_left AL, AL
8609:    02           flag2
860a:    7b 7e        call L_868a
860c:    45 15        mov CL, AL
860e:    03           flag3
...
8672:    2f           rotate_left AL, AL
8673:    04           flag4
8674:    2f           rotate_left AL, AL
8675:    06           flag6
8676:    90 01 00     liw A, 0x0100
8679:    2f           rotate_left AL, AL
867a:    00           HALT
867b:    90 ea 1f     liw A, 0xea1f
867e:    2f           rotate_left AL, AL
867f:    02           flag2
...
L_86e5:
86e5:    8a           unknown
86e6:    41 51        sub AL, CL
86e8:    15 3a        b_nz L_8724
86ea:    3e           rotate_right A, A
86eb:    31 20        sub A, B
...
8702:    8a           unknown
8703:    2b           or AL, AL
8704:    41 51        sub AL, CL
8706:    15 1c        b_nz L_8724
8708:    3e           rotate_right A, A
8709:    31 20        sub A, B
